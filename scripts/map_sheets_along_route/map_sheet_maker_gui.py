...
# ---------------------------------------------------------------
# Purpose:
#   GUI wrapper around the original map_sheet_maker.py script.
#   Opens a dialog to set print size (mm), map scale, overlap,
#   and which layer/features to use.
#
# Workflow:
...
# ---------------------------------------------------------------
# RECTANGLE GENERATOR  (unchanged from original)
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# LINE CHAINING  (sorts and merges multiple segments into one)
# ---------------------------------------------------------------
...
def run_generator(route, crs_authid, map_width, map_height, step):
    ...
    while distance < route_length:
        ...
        azi_math = math.degrees(math.atan2(pt2.x() - pt.x(), pt2.y() - pt.y()))
        rect = make_rect(QgsPointXY(pt), azi_math + 90, map_width, map_height)
